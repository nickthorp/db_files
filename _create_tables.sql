...
CREATE TABLE hoard_comic(
  ...
  comic_email VARCHAR(40) NOT NULL,
  ...
  FOREIGN KEY ( comic_email ) REFERENCES hoard_user( user_email )
);

CREATE TABLE hoard_movie(
  movie_id INT NOT NULL AUTO_INCREMENT,
  movie_email VARCHAR(40) NOT NULL,
...
CREATE TABLE hoard_tv_series(
  ...
  tv_series_email VARCHAR(40) NOT NULL,
  ...
  FOREIGN KEY ( tv_series_email ) REFERENCES hoard_user( user_email )
);

CREATE TABLE hoard_videogame(
  videogame_id INT NOT NULL AUTO_INCREMENT,
  videogame_email VARCHAR(40) NOT NULL,
  ...
  FOREIGN KEY ( videogame_email ) REFERENCES hoard_user( user_email )
);
